...
> NegoSignを単独で利用する場合のユーザーフローと画面仕様を定義します。
...
### 1.1 このパターンの対象ユーザー
- Hubbleを導入していない企業・個人
- 契約交渉ツールとしてNegoSignを単独で使いたいユーザー
...
| 機能 | 理由 |
|------|------|
| 組織・チーム管理 | Hubbleの価値領域。NegoSignは案件単位の交渉に特化する |
| 承認ワークフロー | 同上 |
| 組織横断のダッシュボード | 同上 |
| 管理者ロール | 同上 |
...
> NegoSignで「チームで使いたい」ニーズが発生した場合、Hubbleへの導線で対応する。
