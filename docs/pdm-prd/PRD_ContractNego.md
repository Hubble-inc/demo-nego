...
> **Note:** このドキュメントは再構成されました。詳細は以下を参照してください。
...
### 📄 [PRD_Common.md](./docs/PRD_Common.md)
**共通仕様** - 両パターンで共通する仕様
- プロダクトビジョン・解決する課題
- ターゲットユーザー
...
### 📄 [PRD_Nego_Standalone.md](./docs/PRD_Nego_Standalone.md)
**パターン1: Nego単体利用** - Negoを単独で使う場合
- ユーザーフロー（アップロード→招待→交渉→合意）
- 画面構成（index.html, detail.html, invite.html）
- 新規交渉ウィザード（Step1〜3）
- ファイルアップロード仕様
- 招待・権限管理

### 📄 [PRD_Nego_Hubble.md](./docs/PRD_Nego_Hubble.md)
**パターン2: Hubble連携利用** - HubbleからNegoを使う場合
- ユーザーフロー（Hubble内「交渉相手に共有」→招待→交渉→Hubbleに反映）
